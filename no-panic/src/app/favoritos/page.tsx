  ...
  const getFavoritos = async () => {
    try {
      const { data } = await axios.get(
        `${process.env.NEXT_PUBLIC_SERVER_URL}/usuarios/1/terapeutas`
      );
      setFavoritos(data);
            ...
            {favoritos.length === 0 ? (
              <div className={styles.emptyState}>
                ...
                <p className={styles.emptyText}>
                  Adicione terapeutas aos favoritos durante uma chamada para
                ...
                {favoritos.map((fav) => (
                  <div key={fav.id_usuario} className={styles.card}>
                    ...
                    <div className={styles.cardBody}>
                      <h3 className={styles.cardTitle}>{fav.nome}</h3>
